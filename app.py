...
/* 紧凑列表：缩略图开启时仍保持列表的信息密度。 */
.files.list-layout .file-header,.files.list-layout .file{{grid-template-columns:34px minmax(0,1fr)58px;gap:6px;padding:4px 8px}}.files.list-layout .file{{grid-template-rows:auto;min-height:32px}}.files.list-layout .select input{{width:16px;height:16px}}.files.list-layout.list-thumbnails .file-header,.files.list-layout.list-thumbnails .file{{grid-template-columns:34px 38px minmax(0,1fr)58px}}.files.list-layout.list-thumbnails .file{{grid-template-rows:auto;min-height:38px}}.files.list-layout.list-thumbnails .file-visual{{width:32px;height:32px}}@media (max-width:480px){{.files.list-layout .file{{grid-template-columns:30px minmax(0,1fr)54px;padding:4px}}.files.list-layout.list-thumbnails .file{{grid-template-columns:30px 36px minmax(0,1fr)54px}}.files.list-layout.list-thumbnails .file-visual{{width:30px;height:30px}}}}
</style>
<h1>多用户共享</h1>
{password_controls}
